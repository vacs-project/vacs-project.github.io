...
**Nick Müller**  
on behalf of the vacs project [core maintainers](https://github.com/vacs-project/vacs#core-maintainers)
...
- **Access control:** Server access is restricted to [core maintainers](https://github.com/vacs-project/vacs#core-maintainers) with a legitimate operational need.
...
The vacs Client allows users to configure which server they connect to. If you are unsure which server you are connected to, check your application settings. By default, you will automatically be connected to the Official Servers operated by the [core maintainers](https://github.com/vacs-project/vacs#core-maintainers), which are covered by this Policy.

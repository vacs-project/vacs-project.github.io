...
- **Speaker / Notification Device** (optional)
...
:::tip[Speaker Device]
The optional **Speaker** device allows you to route ringtone/chime sounds and UI click sounds to a separate audio output. This is useful if you want incoming call notifications to play through your desktop speakers while call audio stays in your headset.

If no speaker device is selected, all sounds will play through the headset output.
:::
...
Adjusts the volume of the chime played when receiving an incoming call. This setting controls both regular and [Priority](/using-vacs/making-a-call#prio-calls) call chimes, including [custom ring sounds](/settings/call#ring-sounds) you have configured.

:::tip[Test Before Use]
Press the volume slider to play the call sound and verify the selected volume level. A [custom ring sound](/settings/call#ring-sounds) plays in full.
:::

...
Adjusts the volume of the chime played when receiving an incoming call. This setting controls both regular and [Priority](/using-vacs/making-a-call#prio-calls) call chimes.
